...
class _LevelPassedCardState extends State<LevelPassedCard> {
  ...
  List<Widget> _buildIndicators() {
    return [
      _Indicator(color: Colors.blue, text: 'Completed'),
      _Indicator(color: Colors.yellow, text: 'Partially Completed'),
      _Indicator(color: Colors.grey, text: 'Locked'),
      _Indicator(color: Colors.red, text: 'Unlocked'),
    ];
  }
}
